...
export const metadata: Metadata = {
  ...
  description:
    "Raiz Apartments – Modern, stylish serviced apartments in the heart of Lagos. Studio, 1-bedroom and 2-bedroom units. 15 mins from the airport.",
  keywords:
    "apartments Lagos, short let Lagos, serviced apartments Lagos, Raiz Apartments, Victoria Island, Lekki",
  openGraph: {
    title: "Raiz Apartments | Modern Living in the Heart of Lagos",
    description:
      "Stylish serviced apartments with 24/7 security, high-speed internet, and easy access to Lagos Island, Lekki, and the airport.",
  },
};
